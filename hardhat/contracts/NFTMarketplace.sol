...
contract NFTMarketplace{
    ...
    function createListing(address nftAddress,uint256 price, uint256 tokenId)external isNotListed(nftAddress, tokenId) isNFTOwner(nftAddress,tokenId){
        require(price >= 0, "MRKT:price should be greater than 0" );
        require(listings[nftAddress][tokenId].price == 0, "MRKT: Already listed");
    ...
    function updateListing(address nftAddress,uint256 newPrice, uint256 tokenId) external isListed(nftAddress, tokenId) isNFTOwner(nftAddress,tokenId){
        require(newPrice >0,"MRKT:price should be greater than 0");
